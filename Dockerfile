...
COPY serverinstall_100_12145 /serverinstall_100_12145
COPY stoneblock-3.png /stoneblock-3.png
RUN chmod +x /serverinstall_100_12145
...
ENV MOTD "A Minecraft (FTB Presents Stoneblock 3 1.10.0) Server Powered by Docker"
ENV LEVEL world
ENV LEVELTYPE ""
